...
export class World {
	...
	static new(width, snake_pos, snake_size, reward_idx) {
		const ret = wasm.world_new(
			...
			snake_pos,
			snake_size,
			!isLikeNone(reward_idx),
			isLikeNone(reward_idx) ? 0 : reward_idx,
		);
	...
	snake_cells() {
		try {
			const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
			wasm.world_snake_cells(retptr, this.__wbg_ptr);
			var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
			var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
	 ...
	 */
	snake_body_length() {
		const ret = wasm.world_snake_body_length(this.__wbg_ptr);
		return ret >>> 0;
	}
	/**
	...
	update_direction(direction) {
		wasm.world_update_direction(this.__wbg_ptr, direction);
	}
	/**
	 */
	play() {
		wasm.world_play(this.__wbg_ptr);
	}
	/**
...
function __wbg_get_imports() {
	...
	imports.wbg.__wbindgen_number_new = (arg0) => {
		const ret = arg0;
		return addHeapObject(ret);
	};
	imports.wbg.__wbg_rnd_980494400e562b2a = (arg0) => {
		const ret = rnd(arg0 >>> 0);
		return ret;
	};
	imports.wbg.__wbindgen_error_new = (arg0, arg1) => {
		const ret = new Error(getStringFromWasm0(arg0, arg1));
		return addHeapObject(ret);
	};
	imports.wbg.__wbindgen_bigint_from_u64 = (arg0) => {
		const ret = BigInt.asUintN(64, arg0);
		return addHeapObject(ret);
	};
	imports.wbg.__wbg_new_a220cf903aa02ca2 = () => {
		const ret = [];
		return addHeapObject(ret);
	};
	imports.wbg.__wbg_set_673dda6c73d19609 = (arg0, arg1, arg2) => {
