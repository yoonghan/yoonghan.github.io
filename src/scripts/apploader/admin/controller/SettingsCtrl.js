define(['app', 'reactjs', 'reactloader', '../directive/ngflow'], function (app, react) {
    app.controller('SettingsCtrl', ['$rootScope', '$scope', '$http', '$location', '$route', '$modal', '$mdDialog',
		function($rootScope, $scope, $http, $location, $route, $modal, $mdDialog) {
    ...
    .controller('ModalInstanceCtrl', ['$rootScope', '$scope', '$http', '$modalInstance', 'ver',
		function ($rootScope, $scope, $http, $modalInstance, ver) {
			$scope.ver = ver;
