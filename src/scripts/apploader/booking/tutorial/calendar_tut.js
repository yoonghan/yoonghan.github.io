    ...
    return{
        ...
        tutorialInit:function ($scope, $location){
            ...
            var msg_2 = [
                       ...
                       [11,"You have completed your tutorial. To exit click on the button: <a class='btn btn-primary btnTutNextScreen' href='/site/selfservice/booking/calendar?'>Complete</a>.<br>Thank you for your participation."]
                       ];
