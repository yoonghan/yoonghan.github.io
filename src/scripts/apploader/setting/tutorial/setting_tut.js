    ...
    return{
        tutorialInit:function($scope, $location, $timeout){
            ...
            var msg = [
                       ...
                       [11,"This completes the Settings. Let us return to the Calendar page, by clicking on the button here: <a class='btn btn-primary btnTutNextScreen' href='/site/selfservice/booking/calendar#/?tut=2'>Continue tutorial</a>."]
                       ];
