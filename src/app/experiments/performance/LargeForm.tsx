	...
	return (
		<>
			<div style={{ paddingBottom: 10 }}>
				Goal is to not rerender the whole form, and only rerender inputs
				that will change. However if this form has related changes it
				will not cause a re-render. This is the prop drilling method.
			</div>
			<div>
...
const InputField = ({
	...
	return (
		...
		>
			...
			{renderInput}
			{isEmpty(form[id]) && (
				<div style={{ color: "red", paddingLeft: 1 }}>
					Cannot be empty
				</div>
			)}
		</fieldset>
