export const ai_certifications = [
  ...
  },
  {
    ...
    description: (
      <span>
        Recognize and apply the prompting framework (task, context, references,
        evaluate, iterate) to create effective prompts. Apply the prompting
        framework to extract insights from data, brainstorming.
      </span>
    ),
