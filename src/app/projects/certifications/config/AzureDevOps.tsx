    ...
    return (
        <article>
            ...
            <p>
                ...
                Most learning resources can be obtained from Microsoft Learn.
            </p>
            <strong>Additional Notes:</strong> <Link href="https://github.com/users/yoonghan/projects/4">Azure DevOps</Link>
        </article>
    )
}
