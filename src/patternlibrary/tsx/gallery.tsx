...
const items = [
	{title: 'Node.js',
		imgSrc: 'http://localhost:8080/ext/img/technology/nodejs.png',
	...
	{title: 'React',
    imgSrc: 'http://localhost:8080/ext/img/technology/react.png',
	...
	{title: 'Sass',
    imgSrc: 'http://localhost:8080/ext/img/technology/sass.png',
    ...
    imgSrc: 'http://localhost:8080/ext/img/technology/typescript.png',
	...
	{title: 'CommonJS',
		imgSrc: 'http://localhost:8080/ext/img/technology/commonjs.png',
	...
	{title: 'React Toolbox',
		imgSrc: 'http://localhost:8080/ext/img/technology/reacttoolbox.svg',
	...
	{title: 'Font Awesome',
		imgSrc: 'http://localhost:8080/ext/img/technology/fontawesome.jpg',
	...
	{title: 'Webpack',
		imgSrc: 'http://localhost:8080/ext/img/technology/webpack.png',
	...
	{title: 'Gulp',
		imgSrc: 'http://localhost:8080/ext/img/technology/gulp.png',
	...
	{title: 'Pug / Jade',
		imgSrc: 'http://localhost:8080/ext/img/technology/pug.svg',
	...
	{title: 'Animate.css',
		imgSrc: 'http://localhost:8080/ext/img/technology/npm.png',
