define(["require", "exports"], function (require, exports) {
    var Layer = (function () {
        function Layer(tweenMax, timelineMax) {
            this.run(tweenMax, timelineMax);
        }
        Layer.prototype.run = function (tweenMax, timelineMax) {
            var image = document.getElementById('lyr-atom'), blog = document.getElementById('lyr-blog'), fixer = document.getElementById('lyr-fixer'), tl = new TimelineMax({ repeat: -1 });
