...
describe('PageReaderIndicator', () => {
    ...
    afterAll(() => {
        if(originalOffsetHeight !== undefined && originalScrollHeight !== undefined) {
    ...
    const assertScrollStatus = (scrollTop: number, expectedTextContent: string, expectedWidthPercentage: number) => {
        ...
        expect(scrollContainer).toHaveStyle({width: `${expectedWidthPercentage}%`})
    }
