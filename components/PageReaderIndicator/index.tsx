...
const PageReaderIndicator = ({scrollContainer}: Props) => {
  ...
  React.useEffect(() => {
    if(scrollContainer.current !== null) {
      scrollContainer.current.addEventListener('scroll', updateScrollPercentage, {passive: true});
    }
  }, [scrollContainer])

  return (
    <div className={styles.scrollPercentage} ref={scrollMonitorRef} data-testid="scroll-container">
