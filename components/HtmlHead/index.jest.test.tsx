...
describe('HtmlHead', () => {
  it('renders a heading with right header and title', () => {
    render(<HtmlHead title="Walcron" description='my description'/>, { container: document.head })
    expect(document.title).toEqual("Walcron")
    // eslint-disable-next-line testing-library/no-node-access
    expect(document.querySelector('meta[name="description"]')).toHaveAttribute('content', 'my description')
  })
