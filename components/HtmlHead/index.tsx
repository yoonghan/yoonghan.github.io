...
const HtmlHead = ({description, title}: {description:string, title: string}) => {
  return (
    <>
      <Head>
        ...
        <meta name="og:description" content="Welcome to Walcron Coorperation, Malaysia and Singapore; a site was built for IT research purposes." key="fb_image_desc"/>
      ...
      <Script src="https://www.googletagmanager.com/gtag/js?id=UA-156082636-1" strategy="lazyOnload"/>
      <Script 
        id="reroute-https"
